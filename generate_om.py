...
def build_om(d, matt_photo=None, joe_photo=None):
    ...
    _t(s, Inches(0.8), Inches(1.3), Inches(8.4), Inches(0.4),
       "COMPARABLE SALES DATA", sz=14, bold=True, color=NAVY, align=PP_ALIGN.CENTER)
    _t(s, Inches(0.8), Inches(1.85), Inches(8.4), Inches(0.6),
       f"Populated from GUI deal finder at export.\n"
       f"Exit $/SF: ${d['exit_psf']:,.0f}  |  Target: ${d['exit_psf']:,.0f}/SF  |  "
       f"Break-Even: ${d['break_even_psf']:,.0f}/SF", sz=10, color=S600, align=PP_ALIGN.CENTER)
